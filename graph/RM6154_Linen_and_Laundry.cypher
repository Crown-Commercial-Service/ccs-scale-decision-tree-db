...
(lotLinenLaundryLot1b:Lot:Outcome {uuid: 'ccb59bfc-75b5-11ea-bc55-0242ac130003', agreementName: 'Linen and Laundry Services', lotName: 'Lot 1b - Standard Wash Linen and Laundry Services', description: 'Standard collection, wash, finish and return of buyer owned and hired laundry from the supplier, specialist laundry and cleanroom services.', agreementId: 'RM6154', url: '', type: 'CAT', scale: true}),
(lotLinenLaundryLot1a:Lot:Outcome {uuid: 'ccb5a002-75b5-11ea-bc55-0242ac130003', agreementName: 'Linen and Laundry Services', lotName: 'Lot 1a - Linen Hire with Standard Wash Linen and Laundry Services', description: 'Standard collection, wash, finish and return of buyer owned and hired laundry from the supplier, specialist laundry and cleanroom services.', agreementId: 'RM6154', url: '', type: 'CAT', scale: true}),
(lotLinenLaundryLot2:Lot:Outcome {uuid: 'ccb5a2b4-75b5-11ea-bc55-0242ac130003', agreementName: 'Linen and Laundry Services', lotName: 'Lot 2 - Specialist Laundry Services (Theatre Packs)', description: 'Standard collection, wash, finish and return of buyer owned and hired laundry from the supplier, specialist laundry and cleanroom services.', agreementId: 'RM6154', url: '', type: 'CAT', scale: true}),
(lotLinenLaundryLot3:Lot:Outcome {uuid: 'ccb5a37c-75b5-11ea-bc55-0242ac130003', agreementName: 'Linen and Laundry Services', lotName: 'Lot 3 - Specialist Cleanroom Laundry Services', description: 'Standard collection, wash, finish and return of buyer owned and hired laundry from the supplier, specialist laundry and cleanroom services.', agreementId: 'RM6154', url: '', type: 'CAT', scale: true}),
