...
(lotEduTechLot5:Lot:Outcome {uuid: 'ccb61b7c-75b5-11ea-bc55-0242ac130003', agreementName: 'Education Technology', lotName: 'Lot 5', agreementDescription: 'Educational establishments can buy ICT (Information and Communication Technologies) goods and technology services through one agreement.', lotDescription: "The provision and installation of sound and/or visual equipment. Suppliers under this lot are capable of supplying interactive solutions (whiteboards, tables), digital signage, televisions, AV software, auditorium solutions, training.", agreementId: 'RM6103', url: '', type: 'CAT', scale: true}),
...
// TePAS
(lotTePASLot1:Lot:Outcome {uuid: 'ccb61ec4-75b5-11ea-bc55-0242ac130003', agreementName: 'Technology Products & Associated Services', lotName: 'Lot 1', agreementDescription: 'Offers public sector buyers a compliant route to market for technology product needs (hardware and software) and all associated services.', lotDescription: 'Hardware & Software & Associated Services', agreementId: 'RM6068', url: '', type: 'CAT', scale: false}),

(lotTePASLot2:Lot:Outcome {uuid: 'ccb6202c-75b5-11ea-bc55-0242ac130003', agreementName: 'Technology Products & Associated Services', lotName: 'Lot 2', agreementDescription: 'Offers public sector buyers a compliant route to market for technology product needs (hardware and software) and all associated services.', lotDescription: 'Hardware and Associated Services', agreementId: 'RM6068', url: '', type: 'CAT', scale: false}),

(lotTePASLot3:Lot:Outcome {uuid: 'ccb6214e-75b5-11ea-bc55-0242ac130003', agreementName: 'Technology Products & Associated Services', lotName: 'Lot 3', agreementDescription: 'Offers public sector buyers a compliant route to market for technology product needs (hardware and software) and all associated services.', lotDescription: 'Software and Associated Services', agreementId: 'RM6068', url: '', type: 'CAT', scale: false}),

(lotTePASLot4:Lot:Outcome {uuid: 'ccb622ac-75b5-11ea-bc55-0242ac130003', agreementName: 'Technology Products & Associated Services', lotName: 'Lot 4', agreementDescription: 'Offers public sector buyers a compliant route to market for technology product needs (hardware and software) and all associated services.', lotDescription: 'Information Assured Products & Associated Services', agreementId: 'RM6068', url: '', type: 'CAT', scale: false}),
