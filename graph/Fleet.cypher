...
(ansGrpVehicleLease)-[:HAS_OUTCOME]->(qiVehicleLease:QuestionInstance:Outcome {uuid: 'ee83b641-e75d-4861-af8d-fff743f2feb7'})-[:DEFINED_BY]->(qstnTypeOfService),
    ...
    (ansGrpShortTerm)-[:HAS_OUTCOME]->(qiShortTerm:QuestionInstance:Outcome {uuid: '6c70efe3-9e40-4311-9993-9b1e0019118f'})-[:DEFINED_BY]->(qstnWhere),
