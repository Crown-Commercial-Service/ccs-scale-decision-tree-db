...
(:Question {uuid: '7a61da23-0caf-4e75-be8d-8ec9ca5680d9', text: 'Select which area suits your requirements', type: 'LIST'}),
(:Question {uuid: 'c09d4ce9-1e93-4120-a336-6a1d2058499f', text: 'Select the service you need', type: 'LIST'}),
...
// Questions and answer for CNZ tools
(:Question {uuid: '8d972d0f-fd89-445f-9aa5-ae7a7854c54f', text: 'What solution do you need?', type: 'LIST'}),

(:Answer {uuid: '3e6e89be-56fb-4337-a3d4-c43f24051dd9', text: 'Transport', hint: 'The transport sector is the largest producer of greenhouse gas (GHG) emissions in the UK. Our transport solutions offer everything from street lighting and traffic management to electric vehicles, logistics and sustainable travel. Find out how we can help you reduce your transport carbon emissions'}),
(:Answer {uuid: '38e86c60-f661-45d8-b818-9983aff4c03b', text: 'The built environment', hint: 'The UK public sector needs to reduce carbon emissions in the built environment. Our built environment solutions cover everything from building and construction, to sourcing renewable energy and people services. Find out how we can help you reduce your carbon emissions and minimise the impact on the environment'}),
(:Answer {uuid: '866446e7-2ded-4d5e-ab9e-53bfa6e91d7e', text: 'Hard and soft infrastructure', hint: 'Hard infrastructure like roads and water systems, and soft infrastructure like education and healthcare, work together to provide essential services like energy supply, network connectivity and waste management. Find the infrastructure solutions you need to maximise sustainable outcomes'}),
(:Answer {uuid: '54860990-517d-4e84-a63f-e408e6a146fe', text: 'Technology', hint: 'Understanding the environmental impact of your technology is the first step to reducing your emissions. Our technology solutions cover everything from consumption monitoring to sustainable software, tools and infrastructure. Find out how we can help you reduce carbon emissions from your technology'}),
(:Answer {uuid: '746bec19-7f7e-4fcd-b25e-29a2805cabe7', text: 'Consumption', hint: 'When exploring how we can reduce emissions it’s important not to overlook day-to-day consumption. We can help you manage your buildings, equipment and waste to help you reach Net Zero goals. Find out how we can help you minimise the impact your consumption has on the environment'}),
(:Answer {uuid: '15bd43f3-25b6-4a7d-82ca-ddceb43aa64f', text: 'Funding and resourcing', hint: 'Our research shows funding and resourcing is the biggest obstacle to implementing net zero strategies. We can help with stakeholder coordination, people services and access to affordable and energy efficient technology. Find out how we can help you with decarbonisation initiatives'});
