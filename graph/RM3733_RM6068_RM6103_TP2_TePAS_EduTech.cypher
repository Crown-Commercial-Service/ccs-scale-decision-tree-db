...
// TP2
(lotTP2Lot6:Lot:Outcome {uuid: 'ccb61820-75b5-11ea-bc55-0242ac130003', agreementName: 'Technology Products 2', lotName: 'Lot 6 - Catalogue', description: 'Technology Products 2 (TP2) offers public sector customers a flexible and compliant way to source all their technology product needs (hardware and software).  Further competition Lots 1-5 have expired, Lot 6 catalogue is extended.', agreementId: 'RM3733', url: '', type: 'BAT', scale: true}),

// EduTech
(lotEduTechLot1:Lot:Outcome {uuid: '698c28d0-7fc8-11ea-bc55-0242ac130003', agreementName: 'Education Technology', lotName: 'Lot 1 - ICT Solutions', description: 'Educational establishments can buy ICT (Information and Communication Technologies) goods and technology services through one agreement.', agreementId: 'RM6103', url: '', type: 'CAT', scale: false}),
(lotEduTechLot3:Lot:Outcome {uuid: 'ccb618e8-75b5-11ea-bc55-0242ac130003', agreementName: 'Education Technology', lotName: 'Lot 3 - Broadband Services', description: 'Educational establishments can buy ICT (Information and Communication Technologies) goods and technology services through one agreement.', agreementId: 'RM6103', url: '', type: 'CAT', scale: false}),
(lotEduTechLot4:Lot:Outcome {uuid: 'ccb61a32-75b5-11ea-bc55-0242ac130003', agreementName: 'Education Technology', lotName: 'Lot 4 - Hardware', description: 'Educational establishments can buy ICT (Information and Communication Technologies) goods and technology services through one agreement.', agreementId: 'RM6103', url: '', type: 'CAT', scale: true}),
(lotEduTechLot5:Lot:Outcome {uuid: 'ccb61b7c-75b5-11ea-bc55-0242ac130003', agreementName: 'Education Technology', lotName: 'Lot 5 - Audio Visual', description: 'Educational establishments can buy ICT (Information and Communication Technologies) goods and technology services through one agreement.', agreementId: 'RM6103', url: '', type: 'CAT', scale: true}),

// TS2 (Tech Services)
(lotTS2:Lot:Outcome {uuid: 'ccb61c76-75b5-11ea-bc55-0242ac130003', agreementName: 'Technology Services 2', description: 'ICT services from strategy and service design through transition to operational deployment. Includes large project services and up to top secret classification.', agreementId: 'RM3804', url: '', type: 'CAT', scale: false}),

// TePAS
(lotTePASLot1:Lot:Outcome {uuid: 'ccb61ec4-75b5-11ea-bc55-0242ac130003', agreementName: 'Technology Products & Associated Services', lotName: 'Lot 1 - Hardware & Software & Associated Services', description: 'Offers public sector buyers a compliant route to market for technology product needs (hardware and software) and all associated services.', agreementId: 'RM6068', url: '', type: 'CAT', scale: false}),
(lotTePASLot2:Lot:Outcome {uuid: 'ccb6202c-75b5-11ea-bc55-0242ac130003', agreementName: 'Technology Products & Associated Services', lotName: 'Lot 2 - Hardware and Associated Services', description: 'Offers public sector buyers a compliant route to market for technology product needs (hardware and software) and all associated services.', agreementId: 'RM6068', url: '', type: 'CAT', scale: false}),
...
(lotTePASLot4:Lot:Outcome {uuid: 'ccb622ac-75b5-11ea-bc55-0242ac130003', agreementName: 'Technology Products & Associated Services', lotName: 'Lot 4 - Information Assured Products & Associated Services', description: 'Offers public sector buyers a compliant route to market for technology product needs (hardware and software) and all associated services.', agreementId: 'RM6068', url: '', type: 'CAT', scale: false}),

// Network Services 2
(lotNetworkServices2:Lot:Outcome {uuid: 'ccb6252c-75b5-11ea-bc55-0242ac130003', agreementName: 'Network Services 2', description: 'Telecommunications services including networks for the entire public sector, their associated bodies and agencies, the voluntary sector and charities.', agreementId: 'RM3808', url: '', type: 'CAT', scale: false}),
