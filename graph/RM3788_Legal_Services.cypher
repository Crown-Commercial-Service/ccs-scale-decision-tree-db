...
// WPS Lots
(lotLegalWPSLegalSvcsLot1:Lot:Outcome {uuid: 'ccb5cc12-75b5-11ea-bc55-0242ac130003', agreementName: 'WPS Legal Services', lotName: 'Lot 1 (Regional Service Provision)', description: 'Legal services for the wider public sector.', agreementId: 'RM3788', url: '', type: 'CAT', scale: true}),

(lotLegalWPSLegalSvcsLot2a:Lot:Outcome {uuid: 'ccb5cfaa-75b5-11ea-bc55-0242ac130003', agreementName: 'WPS Legal Services', lotName: 'Lot 2a (Full Service Firms - England & Wales)', description: 'Legal services for the wider public sector.', agreementId: 'RM3788', url: '', type: 'CAT', scale: true}),
(lotLegalWPSLegalSvcsLot2b:Lot:Outcome {uuid: 'ccb5d072-75b5-11ea-bc55-0242ac130003', agreementName: 'WPS Legal Services', lotName: 'Lot 2b (Full Service Firms - Scotland)', description: 'Legal services for the wider public sector.', agreementId: 'RM3788', url: '', type: 'CAT', scale: true}),
(lotLegalWPSLegalSvcsLot2c:Lot:Outcome {uuid: 'ccb5d130-75b5-11ea-bc55-0242ac130003', agreementName: 'WPS Legal Services', lotName: 'Lot 2c (Full Service Firms - Northern Ireland)', description: 'Legal services for the wider public sector.', agreementId: 'RM3788', url: '', type: 'CAT', scale: true}),

(lotLegalWPSLegalSvcsLot3:Lot:Outcome {uuid: 'ccb5cce4-75b5-11ea-bc55-0242ac130003', agreementName: 'WPS Legal Services', lotName: 'Lot 3 (Property & Construction)', description: 'Legal services for the wider public sector.', agreementId: 'RM3788', url: '', type: 'CAT', scale: true}),
(lotLegalWPSLegalSvcsLot4:Lot:Outcome {uuid: 'ccb5cdac-75b5-11ea-bc55-0242ac130003', agreementName: 'WPS Legal Services', lotName: 'Lot 4 (Transport Rail)', description: 'Legal services for the wider public sector.', agreementId: 'RM3788', url: '', type: 'CAT', scale: true}),
