...
(lotFM2Lot2aFC:Lot:Outcome {uuid: 'b879e106-654e-11ea-bc55-0242ac130003', agreementName: 'Workplace Services (FM Marketplace Phase 2)', lotName: 'Lot 2a: Defence Housing Management Services (National)', agreementDescription: 'Security, housing and defence facilities management (FM) services.', lotDescription: 'Defence Housing Management Services (National)', agreementId: 'RM6089', url: '', type: 'CAT', scale: false, routeToMarket: "FC"}),

(lotFM2Lot3FC:Lot:Outcome {uuid: 'b879e250-654e-11ea-bc55-0242ac130003', agreementName: 'Workplace Services (FM Marketplace Phase 2)', lotName: 'Lot 3: MOD Facilities Management Marketplace', agreementDescription: 'Security, housing and defence facilities management (FM) services.', lotDescription: 'MOD Facilities Management Marketplace', agreementId: 'RM6089', url: '', type: 'CAT', scale: false, routeToMarket: "FC"}),

(lotFM2Lot2cFC:Lot:Outcome {uuid: 'b879e386-654e-11ea-bc55-0242ac130003', agreementName: 'Workplace Services (FM Marketplace Phase 2)', lotName: 'Lot 2c: Housing Maintenance and Management Services', agreementDescription: 'Security, housing and defence facilities management (FM) services.', lotDescription: 'Housing Maintenance and Management Services', agreementId: 'RM6089', url: '', type: 'CAT', scale: true, routeToMarket: "FC"}),

// Security specific
(lotFM2Lot1aFC:Lot:Outcome {uuid: 'b879e476-654e-11ea-bc55-0242ac130003', agreementName: 'Workplace Services (FM Marketplace Phase 2)', lotName: 'Lot 1a: Security Services', agreementDescription: 'Security, housing and defence facilities management (FM) services.', lotDescription: 'Security Services', agreementId: 'RM6089', url: '', type: 'CAT', scale: true, routeToMarket: "FC"}),

(lotFM2Lot1bFC:Lot:Outcome {uuid: 'b879e566-654e-11ea-bc55-0242ac130003', agreementName: 'Workplace Services (FM Marketplace Phase 2)', lotName: 'Lot 1b: Technical Security', agreementDescription: 'Security, housing and defence facilities management (FM) services.', lotDescription: 'Technical Security', agreementId: 'RM6089', url: '', type: 'CAT', scale: true, routeToMarket: "FC"}),
