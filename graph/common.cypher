...
// Common endpoints
(:Lot:Outcome {uuid: 'b879e69c-654e-11ea-bc55-0242ac130003', name: 'Facilities Management Marketplace', description: 'UK-wide facilities management (FM) services organised regionally and available to all public sector entities. Includes maintenance, cleaning, security, helpdesk etc.', agreementId: 'RM3830', url: ''});
