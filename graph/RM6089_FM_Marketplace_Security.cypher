...
(ansGrpSecServicesWPS)-[:HAS_ANSWER {order: 3}]->(ansSectorLG),
(ansGrpSecServicesWPS)-[:HAS_ANSWER {order: 4}]->(ansSectorEdu),
(ansGrpSecServicesWPS)-[:HAS_ANSWER {order: 5}]->(ansSectorDevolved),
(ansGrpSecServicesWPS)-[:HAS_ANSWER {order: 6}]->(ansSectorHealth),
...
(ansGrpSecTechServicesWPS)-[:HAS_ANSWER {order: 3}]->(ansSectorLG),
(ansGrpSecTechServicesWPS)-[:HAS_ANSWER {order: 4}]->(ansSectorEdu),
(ansGrpSecTechServicesWPS)-[:HAS_ANSWER {order: 5}]->(ansSectorDevolved),
(ansGrpSecTechServicesWPS)-[:HAS_ANSWER {order: 6}]->(ansSectorHealth),
